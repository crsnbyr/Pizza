import java.util.*;
public class Main {
    //This was Bullveye and Carson's code before we had all the issues on github.
    //Uploading as a file now to be merged and fixed at a later date.
    ...
    static void displayRecipe(Recipe recipe) {
        ...
        //this art is supposed to be a bowl, not an artist
    }
}
